...
const STATIC_ROUTES = [
  ...
  { path: '/vacation-pay', changefreq: 'monthly', priority: '0.9' },
  { path: '/work-experience', changefreq: 'monthly', priority: '0.9' },
  { path: '/autocredit', changefreq: 'monthly', priority: '0.8' },
  ...
  { path: '/percentage', changefreq: 'monthly', priority: '0.9' },
  { path: '/percentage/percent-of-number', changefreq: 'monthly', priority: '0.8' },
  { path: '/percentage/add-percent', changefreq: 'monthly', priority: '0.8' },
  { path: '/percentage/subtract-percent', changefreq: 'monthly', priority: '0.8' },
  { path: '/percentage/percentage-change', changefreq: 'monthly', priority: '0.8' },
  { path: '/percentage/what-percent', changefreq: 'monthly', priority: '0.8' },
  { path: '/days-between-dates', changefreq: 'monthly', priority: '0.9' },
  { path: '/date-add', changefreq: 'monthly', priority: '0.8' },
  { path: '/time-between', changefreq: 'monthly', priority: '0.8' },
  { path: '/discount', changefreq: 'monthly', priority: '0.9' },
  { path: '/age', changefreq: 'monthly', priority: '0.9' },
  ...
  { path: '/math', changefreq: 'monthly', priority: '0.8' },
